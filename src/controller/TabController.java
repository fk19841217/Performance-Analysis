...
//    }
    ...
    public GithubLoginDialogController showGithubLoginDialog(){
    	...
    	public void aqosa() throws Exception {
    		...
    		run.setArchiveLogger("C:/Users/恺/workspace/Performance-Analysis/src/icons/mytest.tsv");
    		run.setOptimumLogger("C:/Users/恺/workspace/Performance-Analysis/src/icons/myopt.tsv");
    		//run.setViewer();
    		run.call();
           ...
           String[] str=new String[5];
    		...
    		for (String result : run.getResults()) {
    			...
    			if(counter==run.getResults().size()){
    			        ...
    			        FileReader fr=new FileReader("C:/Users/恺/workspace/Performance-Analysis/src/icons/myopt.tsv");
