...
public class CreateNodeController {
    ...
    public void onMouseReleasedActor(){
        diagramController.createNodeView(new ActorNode(mouseDragRectangle.getX(), mouseDragRectangle.getY(),
                mouseDragRectangle.getWidth(),
                mouseDragRectangle.getHeight()), false);
        finish(mouseDragRectangle);
    }
    
    public void onMouseReleasedUsecase(){
        diagramController.createNodeView(new UsecaseNode(mouseDragRectangle.getX(), mouseDragRectangle.getY(),
                mouseDragRectangle.getWidth(),
                mouseDragRectangle.getHeight()), false);
        finish(mouseDragRectangle);
    }
    
    public void onMouseReleasedNode(){
        diagramController.createNodeView(new NodeNode(mouseDragRectangle.getX(), mouseDragRectangle.getY(),
                mouseDragRectangle.getWidth(),
                mouseDragRectangle.getHeight()), false);
        finish(mouseDragRectangle);
    }
    ...
    public void onMouseReleasedDeployment(){
        diagramController.createNodeView(new DeploymentNode(mouseDragRectangle.getX(), mouseDragRectangle.getY(),
                mouseDragRectangle.getWidth(),
                mouseDragRectangle.getHeight()), false);
        finish(mouseDragRectangle);
    }
    
    public void onMouseReleasedLinkedDeployment(){
        diagramController.createNodeView(new LinkedDeploymentNode(mouseDragRectangle.getX(), mouseDragRectangle.getY(),
                mouseDragRectangle.getWidth(),
                mouseDragRectangle.getHeight()), false);
        finish(mouseDragRectangle);
    }
    
    public void onMouseReleasedLinkedSequence(){
        diagramController.createNodeView(new LinkedSequenceNode(mouseDragRectangle.getX(), mouseDragRectangle.getY(),
                mouseDragRectangle.getWidth(),
                mouseDragRectangle.getHeight()), false);
        finish(mouseDragRectangle);
    }
